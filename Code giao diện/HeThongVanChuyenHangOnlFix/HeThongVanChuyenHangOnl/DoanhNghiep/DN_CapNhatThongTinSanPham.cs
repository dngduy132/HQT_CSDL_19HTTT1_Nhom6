...
namespace HeThongVanChuyenHangOnl.DoanhNghiep
{
    public partial class DN_CapNhatThongTinSanPham : Form
    {
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            query = "CAPNHAT_TTIN_SP_FIX N'" + comBoxMaSP.SelectedValue + "', N'" + textTenSP.Text + "', N'" + textGiaSP.Text + "', N'" + textSoLuong.Text + "'";
        ...
        private void btnHuy_Click(object sender, EventArgs e)
        {
            ...
            string query = "CAPNHAT_TTIN_SP_ROLLBACK_FIX N'" + comBoxMaSP.SelectedValue + "', N'" + textTenSP.Text + "', N'" + textGiaSP.Text + "', N'" + textSoLuong.Text + "'";
            function.RunSQL(query);
            MessageBox.Show("Bạn đã cập nhật thành công sản phẩm ^.^", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ResetValueCapNhat();
        }
