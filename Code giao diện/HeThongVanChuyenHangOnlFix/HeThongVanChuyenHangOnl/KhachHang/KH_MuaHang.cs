...
namespace HeThongVanChuyenHangOnl.KhachHang
{
    public partial class KH_MuaHang : Form
    {
        ...
        DataSet GetAllMuaSP()
        {
            ...
            string query = "KH_XEM_SP_THEO_MADN_FIX N'" + comBoxMaDN.SelectedValue + "'";
        ...
        {
            string query;
            query = "KH_XEM_SP_THEO_MADN_FIX N'" + comBoxMaDN.SelectedValue + "'";
        ...
        private void btnDatHang_Click(object sender, EventArgs e)
        {
            ...
            query = "KH_MUA_HANG_FIX N'" + n + "', N'"+ comBoxKV.SelectedValue +"', N'" + comBoxMaDN.SelectedValue + "', N'" + comBoxMaKH.SelectedValue + "', N'" + comBoxHTTT.SelectedValue + "', N'" + textSoLuong.Text + "', N'" + comBoxMaSP.SelectedValue + "'";
            function.RunSQL(query);
